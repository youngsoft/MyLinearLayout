...
-(void)loadView
{
    ...
    numField.leftMargin = numField.rightMargin = 0;
    numField.height = 40;
    ...
    infoLayout.leftMargin = infoLayout.rightMargin = 0;
    ...
    ageLayout.gravity = MGRAVITY_HORZ_FILL;
    ageLayout.padding = UIEdgeInsetsMake(5, 5, 5, 5);
    ageLayout.topMargin = 20;
    ageLayout.leftMargin = ageLayout.rightMargin = 0;
    ...
    addressLayout.leftMargin = addressLayout.rightMargin = 0;
    ...
    sexLayout.leftMargin = sexLayout.rightMargin = 0;
    ...
    bottomView.leftMargin = bottomView.rightMargin = 0;
