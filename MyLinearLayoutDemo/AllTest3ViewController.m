...
-(MyLinearLayout*)createActionLayout:(NSString*)title action:(SEL)action
{
    ...
    actionLayout.gravity = MGRAVITY_VERT_CENTER;
...
{
    MyLinearLayout *switchLayout = [MyLinearLayout linearLayoutWithOrientation:LVORIENTATION_HORZ];
    ...
    switchLayout.gravity = MGRAVITY_VERT_CENTER;
...
-(void)loadView
{
    ...
    scrollView.marginGravity = MGRAVITY_FILL;
    ...
    contentLayout.gravity = MGRAVITY_HORZ_FILL;  //让子视图全部水平填充
    ...
    //可以设置背景和高亮背景图片的布局。
    MyLinearLayout *layout11 = [MyLinearLayout linearLayoutWithOrientation:LVORIENTATION_VERT];
    ...
    MyLinearLayout *layout8 = [MyLinearLayout linearLayoutWithOrientation:LVORIENTATION_VERT];
    layout8.backgroundColor = [UIColor whiteColor];
    layout8.gravity = MGRAVITY_HORZ_FILL;
    ...
    //底部添加一个MyFlowLayout
    MyFlowLayout *layout10 = [MyFlowLayout flowLayoutWithOrientation:LVORIENTATION_VERT arrangedCount:3];
    ...
    button.height = 50;
    button.marginGravity = MGRAVITY_VERT_BOTTOM | MGRAVITY_HORZ_FILL;
