...
{
    //流式布局后面的例子有说明
    MyFlowLayout *flowLayout1 = [MyFlowLayout flowLayoutWithOrientation:LVORIENTATION_VERT arrangedCount:3];
...
-(void)loadView
{
    ...
    rootLayout.leftMargin = rootLayout.rightMargin = 0;
    [scrollView addSubview:rootLayout];
    
    rootLayout.gravity = MGRAVITY_HORZ_FILL;  //设置这个属性后rootLayout的所有子视图都不需要指定宽度了，这个值的意义是所有子视图的宽度都填充满布局。也就是说设置了这个值后不需要为每个子视图设置leftMargin, rightMargin来指定宽度了。
    ...
    self.vertGravityLayout = [MyLinearLayout linearLayoutWithOrientation:LVORIENTATION_VERT];
    self.vertGravityLayout.height = 200;
    self.vertGravityLayout.topMargin = 10;
    self.vertGravityLayout.leftMargin = 20;
    ...
    self.horzGravityLayout = [MyLinearLayout linearLayoutWithOrientation:LVORIENTATION_HORZ];
    self.horzGravityLayout.wrapContentWidth = NO;
    self.horzGravityLayout.height = 100;
    self.horzGravityLayout.topMargin = 10;
    self.horzGravityLayout.leftMargin = 20;
...
-(void)handleGravity:(UIButton*)button
{
    switch (button.tag) {
        case 100:  //上
            ...
            break;
        case 200:  //垂直
            self.vertGravityLayout.gravity = (self.vertGravityLayout.gravity & MGRAVITY_VERT_MASK) | MGRAVITY_VERT_CENTER;
            break;
        case 300:   //下
            self.vertGravityLayout.gravity = (self.vertGravityLayout.gravity & MGRAVITY_VERT_MASK) | MGRAVITY_VERT_BOTTOM;
            break;
        case 400:  //左
            self.vertGravityLayout.gravity = (self.vertGravityLayout.gravity & MGRAVITY_HORZ_MASK) | MGRAVITY_HORZ_LEFT;
            break;
        case 500:  //水平
            self.vertGravityLayout.gravity = (self.vertGravityLayout.gravity & MGRAVITY_HORZ_MASK) | MGRAVITY_HORZ_CENTER;
            break;
        case 600:   //右
            self.vertGravityLayout.gravity = (self.vertGravityLayout.gravity & MGRAVITY_HORZ_MASK) | MGRAVITY_HORZ_RIGHT;
            break;
        case 700:   //填充
            self.vertGravityLayout.gravity = (self.vertGravityLayout.gravity & MGRAVITY_HORZ_MASK) | MGRAVITY_HORZ_FILL;
            break;
        case 800:   //窗口垂直居中
            self.vertGravityLayout.gravity = (self.vertGravityLayout.gravity & MGRAVITY_VERT_MASK) | MGRAVITY_VERT_WINDOW_CENTER;
            break;
        case 900:   //窗口水平居中
        ...
        case 101:  //左
            self.horzGravityLayout.gravity = (self.horzGravityLayout.gravity & MGRAVITY_HORZ_MASK) | MGRAVITY_HORZ_LEFT;
            break;
        case 201:  //水平
            self.horzGravityLayout.gravity = (self.horzGravityLayout.gravity & MGRAVITY_HORZ_MASK) | MGRAVITY_HORZ_CENTER;
            break;
        case 301:   //右
            self.horzGravityLayout.gravity = (self.horzGravityLayout.gravity & MGRAVITY_HORZ_MASK) | MGRAVITY_HORZ_RIGHT;
            break;
        case 401:  //上
            self.horzGravityLayout.gravity = (self.horzGravityLayout.gravity & MGRAVITY_VERT_MASK) | MGRAVITY_VERT_TOP;
            break;
        case 501:  //垂直
            self.horzGravityLayout.gravity = (self.horzGravityLayout.gravity & MGRAVITY_VERT_MASK) | MGRAVITY_VERT_CENTER;
            break;
        case 601:   //下
            self.horzGravityLayout.gravity = (self.horzGravityLayout.gravity & MGRAVITY_VERT_MASK) | MGRAVITY_VERT_BOTTOM;
            break;
        case 701:   //填充
            self.horzGravityLayout.gravity = (self.horzGravityLayout.gravity & MGRAVITY_VERT_MASK) | MGRAVITY_VERT_FILL;
            break;
        case 801:   //窗口垂直居中
            self.horzGravityLayout.gravity = (self.horzGravityLayout.gravity & MGRAVITY_VERT_MASK) | MGRAVITY_VERT_WINDOW_CENTER;
            break;
        case 901:   //窗口水平居中
            self.horzGravityLayout.gravity = (self.horzGravityLayout.gravity & MGRAVITY_HORZ_MASK) | MGRAVITY_HORZ_WINDOW_CENTER;
            break;
...
{
    MyLinearLayout *navigationItemLayout = [MyLinearLayout linearLayoutWithOrientation:LVORIENTATION_VERT];
    navigationItemLayout.wrapContentHeight = navigationItemLayout.wrapContentWidth = NO;
    
    //通过MGRAVITY_HORZ_WINDOW_CENTER的设置总是保证在窗口的中间而不是布局视图的中间。
    navigationItemLayout.gravity = MGRAVITY_HORZ_WINDOW_CENTER | MGRAVITY_VERT_CENTER;
    ...
    topLabel.leftMargin = topLabel.rightMargin = 10;
    [topLabel sizeToFit];
