...
-(void)loadView
{
    ...
    rightImageView.marginGravity = MGRAVITY_HORZ_RIGHT | MGRAVITY_VERT_TOP;
    rightImageView.topMargin = 10;
    rightImageView.rightMargin = 10;
    ...
    headImage.marginGravity = MGRAVITY_CENTER;
    ...
    [nickName sizeToFit];
    nickName.marginGravity = MGRAVITY_CENTER;
    ...
    leftView.marginGravity = MGRAVITY_VERT_BOTTOM | MGRAVITY_HORZ_LEFT;
    ...
    centerView.marginGravity = MGRAVITY_VERT_BOTTOM | MGRAVITY_HORZ_CENTER;
    ...
    rightView.marginGravity = MGRAVITY_VERT_BOTTOM | MGRAVITY_HORZ_RIGHT;
