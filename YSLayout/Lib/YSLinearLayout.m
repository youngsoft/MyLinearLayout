...
#import "YSLinearLayout.h"
#import "YSLayoutInner.h"
#import <objc/runtime.h>

@implementation UIView(YSLinearLayoutExt)

-(CGFloat)weight
{
    return self.ysLayoutSizeClass.weight;
}

-(void)setWeight:(CGFloat)weight
{    
    self.ysLayoutSizeClass.weight = weight;
...
@implementation YSLinearLayout



-(id)initWithOrientation:(YSLayoutViewOrientation)orientation
{
    self = [self init];
    if (self)
    {
...
+(id)linearLayoutWithOrientation:(YSLayoutViewOrientation)orientation
{
...
{
    if (orientation == YSLayoutViewOrientation_Vert)
...
-(CGFloat)calcSelfMeasure:(CGFloat)selfMeasure subviewMeasure:(CGFloat)subviewMeasure headPos:(YSLayoutPos*)headPos centerPos:(YSLayoutPos*)centerPos tailPos:(YSLayoutPos*)tailPos
{
