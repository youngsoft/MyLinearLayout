 ...
 *  视图在布局中的尺寸对象
 */
@interface YSLayoutDime : NSObject
...
/*NSNumber, YSLayoutDime以及YSLayoutDime数组，
 ***NSNumber值表示指定具体的宽度或者高度
 ***YSLayoutDime值表示宽度和高度与设置的对象有依赖关系
 ***YSLayoutDime数组的概念就是所有数组里面的子视图的尺寸平分父视图的尺寸。只有相对布局里面的子视图才支持这种设置。
 */
