...
@interface UIView(YSLinearLayoutExt)
 ...
 */
@interface YSLinearLayout : YSLayoutBase
...
//这个属性通常和ysPadding结合用来设置一些统一的边距值
...
//兼容老版本定义
typedef YSLinearLayout MyLinearLayout YSDEPRECATED("use YSLinearLayout!");
