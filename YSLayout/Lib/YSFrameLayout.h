...
@interface UIView(YSFrameLayoutExt)

//用于指定视图在框架布局中的停靠位置，也就是在父视图中的停靠策略,这个属性只有放在框架布局才有意义，默认值是YSMarginGravity_None表示停靠在左上角
...
/*
 ...
 2.视图的中设置的ysLeftMargin,ysTopMargin,ysRightMargin,ysBottomMargin中所设定的值表示距离框架布局的各个边界的偏移值。
 ...
 */
@interface YSFrameLayout : YSLayoutBase

@end


//兼容老版本定义
typedef YSFrameLayout MyFrameLayout YSDEPRECATED("use YSFrameLayout!");