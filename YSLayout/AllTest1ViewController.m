...
- (void)viewDidLoad {
    ...
    label1.ysCenterXOffset = 0;
    [label1 sizeToFit];
    [headerViewLayout addSubview:label1];
    
    UILabel *label2 = [UILabel new];
    label2.text = @"可以直接设置frame值来指定高度";
    label2.ysCenterXOffset = 0;
    label2.ysTopMargin = 10;
    [label2 sizeToFit];
    ...
    YSLinearLayout *bottomViewLayout = [YSLinearLayout linearLayoutWithOrientation:YSLayoutViewOrientation_Vert];
    bottomViewLayout.backgroundColor = [UIColor grayColor];
    
    UILabel *label3 = [UILabel new];
    label3.text = @"设置tableFooterView";
    label3.ysCenterXOffset = 0;
    [label3 sizeToFit];
    [bottomViewLayout addSubview:label3];
    
    UILabel *label4 = [UILabel new];
    label4.text = @"如果不用frame则需要调用layoutIfNeeded";
    label4.ysCenterXOffset = 0;
    label4.ysTopMargin = 10;
    [label4 sizeToFit];
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil)
    {
        ...
        YSRelativeLayout *dialogLayout = [YSRelativeLayout new];
        dialogLayout.tag = 50;
        ...
        /*
         ...
         YSLinearLayout *dialogLayout= [YSLinearLayout linearLayoutWithOrientation:YSLayoutViewOrientation_Horz];
         dialogLayout.tag = 50;
         [dialogLayout setTarget:self action:@selector(handleTest:)];
         
         
         
         dialogLayout.ysLeftMargin = 0;
         dialogLayout.ysRightMargin = 0;
         dialogLayout.wrapContentHeight = YES;
         [cell.contentView addSubview:dialogLayout];
         ...
         YSLinearLayout *messageLayout = [YSLinearLayout linearLayoutWithOrientation:YSLayoutViewOrientation_Vert];
         
         messageLayout.weight = 1;
         messageLayout.ysLeftMargin = 5;
         ...
         nickNameLabel.ysBottomMargin = 5;
         ...
         textMessageLabel.ysLeftMargin = 0;
         textMessageLabel.ysRightMargin = 0;
         textMessageLabel.flexedHeight = YES;
         textMessageLabel.numberOfLines = 0;
         ...
         imageMessageView.ysCenterXOffset = 0;
         imageMessageView.ysTopMargin = 5;
    ...
    //这里最后一行没有下划线
    YSLayoutBase *dialogLayout = (YSLayoutBase*)[cell viewWithTag:50];
    if (indexPath.row  == self.dialogs.count - 1)
        dialogLayout.bottomBorderLine = nil;
    else
    {
        YSBorderLineDraw  *bld = [[YSBorderLineDraw alloc] initWithColor:[UIColor redColor]];
...
-(void)handleTest:(YSLayoutBase*)sender
{
