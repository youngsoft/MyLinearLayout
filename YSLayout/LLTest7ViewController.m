...
@property(nonatomic, strong) YSLinearLayout *testLayout;
...
-(void)loadView
{
    ...
    YSLinearLayout *action1Layout = [YSLinearLayout linearLayoutWithOrientation:YSLayoutViewOrientation_Horz];
    ...
    YSLinearLayout *action2Layout = [YSLinearLayout linearLayoutWithOrientation:YSLayoutViewOrientation_Horz];
    action2Layout.wrapContentHeight = YES;
    action2Layout.ysTopMargin = 5;
...
-(void)handleAction:(UIButton*)sender
{
   ...
   NSArray *arr = self.testLayout.subviews;
    ...
    [v1 resetYSLayoutSetting];
    [v2 resetYSLayoutSetting];
    [v3 resetYSLayoutSetting];
