...
-(YSRelativeLayout*)createLayout1
{
    YSRelativeLayout *layout = [YSRelativeLayout new];
...
-(YSRelativeLayout*)createLayout2
{
    YSRelativeLayout *layout = [YSRelativeLayout new];
...
-(YSRelativeLayout*)createLayout3
{
    YSRelativeLayout *layout = [YSRelativeLayout new];
...
-(void)loadView
{
    ...
    YSRelativeLayout *layout1 =  [self createLayout1]; //[YSRelativeLayout new];
    YSRelativeLayout *layout2 = [self createLayout2];
    YSRelativeLayout *layout3 = [self createLayout3];
