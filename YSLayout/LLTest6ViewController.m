...
-(void)loadView
{
    ...
    labe1.text = @"用户信息";
    [labe1 sizeToFit];
    labe1.ysTopMargin = 10;
    labe1.ysCenterXOffset = 0;
    ...
    imgView.ysTopMargin = 0.25;
    imgView.ysCenterXOffset = 0;
    ...
    txtField.ysHeight = 40;
    txtField.ysLeftMargin = 0.1;
    txtField.ysRightMargin = 0.1;
    txtField.ysTopMargin = 0.1;
    ...
    textView.ysLeftMargin = 0.05;
    textView.ysRightMargin = 0.05;
    textView.ysBottomMargin = 0.65;
